...
export const INITIAL_CAMPAIGNS: Campaign[] = [
  ...
  },
  {
    ...
    cuponsMeta: 4500,
    premios: 4,
    premiosDescricao: 'Spa day, joias, vales-compra e cestas premium',
...
export const INITIAL_COMUNICADOS: Comunicado[] = [
  ...
  },
  {
    ...
    conteudo: 'Comunicamos que haverá manutenção programada do gateway de pagamento integrado ao Itaplan entre 02h00 e 04h00 do dia 20/12/2025. Operações com cartão podem ser intermitentes neste período. Recomendamos comunicar a equipe noturna e ter alternativa de cobrança disponível.',
